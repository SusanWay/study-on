 ...
 */
final class Version20230503225241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT NOT NULL, character_code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, content VARCHAR(1000) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, id_course_id INT NOT NULL, name VARCHAR(255) NOT NULL, content TEXT NOT NULL, lesson_number INT NOT NULL, PRIMARY KEY(id))');
